...
| `product`  | `admin.py`    | ![admin.py](/static/pep8/admin-product.PNG)        |
| `product`  | `context_processors.py`    | ![context_processors.py](/static/pep8/context_processors-product.PNG)        |
| `product`  | `forms.py`    | ![forms.py](/static/pep8/forms-product.PNG)        |
...
- Previously, I had deployed my project on my purchased hosting because I was facing issues with Heroku. However, I was unable to submit the assessment using that link. Therefore, I had to redeploy the project on Heroku for the assessment, which required editing several files in the project.
